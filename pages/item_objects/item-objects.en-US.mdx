...
```lua
awful.NewItem(itemID) -> Item Object
```
...
> You can use **[awful.Populate](toolbox-general?id=Populate)** to make a list of item objects available to your routine actor and the scope of your SpellBook file.
>
> ```lua
> local actor = project.hunter.survival
> local items = {
>   healthstone = awful.NewItem(5512),
> }
