...
> This namespace is made available to **your project and only your project**. It allows you to **build out your own extensive API**, **store and access data and functions between your other files**, and **expose variables to awful to unlock magic capabilities, such as syncing settings.
