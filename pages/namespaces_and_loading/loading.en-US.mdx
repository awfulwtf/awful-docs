...
- On load, awful immerses your files in a bubble environment that contains most protected API unlocked and modified to be consistent between supported platforms. It also passes you [common namespaces](namespaces#common-namespaces) to make use of our API and establish your own.
...
> Within your base project directory ( awful/routines/**project** ) folder, you need to create a file named **awful-config.json**. You can assign a load order manually within this file. It must have the **.json** extension or it will not be recognized.
