...
- **Table Population:** In regard to the enemy table being populated. Keep in mind that unless explicitly stated otherwise, special mobs like Shades, and other things will be included in the enemies table. There are also specific mobs in certain that never have a combat status nor target a player, such as the Phase 2 images of Mueh'zala, these will also be populated in the table.
